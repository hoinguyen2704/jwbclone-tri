            ...
            <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                <form id="form">
                            ...
                            <div class="carousel carousel-nav" data-flickity='{"contain": true, "pageDots": false }'>
                                ...
                                <c:if test="${not empty uniqueDates}">
                                    <c:forEach items="${uniqueDates}" var="date" varStatus="status">
                                        <button class="carousel-cell" id="${status.index}" data-movie-id="${movie_id}"
                                                onclick="myFunction(${status.index}, '${date}')">
                    ...
                    <fieldset>
                        ...
                        <input type="button" name="next-step" class="next-step pay-btn" value="Confirm Information"
