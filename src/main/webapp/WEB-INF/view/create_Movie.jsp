...
<div class="container_signup_signin2 d-inline-flex mt-10" id="container_signup_signin2"
    ...
    <div class="form-container2 sign-up-container2">
        <form:form method="post" name="sign-up-form" action="${action}" onsubmit="return signUpValidateForm()"
                   modelAttribute="Movie_data" cssStyle="width: 100%; height: 100%;">
            ...
            <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                <div>
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Movie
                            title:</label>
                        <form:input path="movie_title" name="movie_title" type="text"
                                    style=""
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        ...
                        <form:input path="movie_description" name="movie_description" type="text"
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        ...
                        <form:input path="movie_duration" name="movie_duration" type="text"
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Trailer
                            url:</label>
                        <form:input path="movie_trailer_url" name="movie_trailer_url" type="text"
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Movie
                            poster
                            url:</label>
                        <form:input path="movie_poster_url" name="movie_poster_url" type="text"
                                    style=""
                                    placeholder="${customer_placeholder.movie_poster_url}"
                                    value="${customer_value.movie_poster_url}"/>
                    </div>
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Release
                            date:</label>
                        <form:input path="movie_release_date" name="movie_release_date" type="date"
                                    style=""
                                    placeholder="${customer_placeholder.movie_release_date}"
                                    value="${customer_value.movie_release_date}"/>
                    </div>
                ...
                <div>
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Country:</label>
                        <form:input path="movie_country" name="movie_country" type="text"
                                    style=""
                                    placeholder="${customer_placeholder.movie_country}"
                                    value="${customer_value.movie_country}"/>
                    </div>
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Studio:</label>
                        <form:input path="movie_studio" name="movie_studio" type="text"
                                    style=""
                                    placeholder="${customer_placeholder.movie_studio}"
                                    value="${customer_value.movie_studio}"/>
                    </div>
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Main
                            actor:</label>
                        <form:input path="movie_main_actor" name="movie_main_actor" type="text"
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        ...
                        <form:input path="movie_director" name="movie_director" type="text"
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        ...
                        <form:input path="movie_genre" name="movie_genre" type="text"
                    ...
                    <div class="form-group d-flex " style="display: inline-flex; width: 100%;align-items: center;">
                        <label style="margin-left: 0px;width: 180px; justify-self: start; text-align: left;">Movie for
                            Age:</label>
                        <form:input path="movie_for_age" name="movie_for_age" type="text"
